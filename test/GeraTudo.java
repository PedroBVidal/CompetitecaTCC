...
public class GeraTudo {
    ...
    public static void main(String[] args) {
       ...
       // up2DAO.salvar(up2);
        ...
        SistemaDeContagem sistemaDeContagem2 = new SistemaDeContagem(0, 2, 0, 1, "Sistema 2-1");
        SistemaDeContagem sistemaDeContagem3 = new SistemaDeContagem(0, 3, 0, 1, "Sistema 3-1");
