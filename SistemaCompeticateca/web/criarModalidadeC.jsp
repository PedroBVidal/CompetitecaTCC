        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="list-group">
                        <a href="equipes.jsp" class="list-group-item">Gerenciar Equipes</a>
                        <a href="criarModalidadeC.jsp" class="list-group-item active">Adicionar uma Modalidade</a>
            ...
            if(request.getParameter("msg") != null){
                ...
                String cor = request.getParameter("color");
                    ...
                    %>
                    <form action="scripts/editarModalidadeC.jsp" method="POST" class="col">
