    ...
    <body>
        ...
        <div class="container">
            <h1 class="my-4">Editar Usuário</h1>
                            ...
                            <form action="scripts/scriptuser.jsp" method="POST" class="col">
                                <input type="hidden" name="c" value="2">
                                <input type="hidden" name="id" value="<%=up.getIdUsuario()%>">
                                
                                <label for="" class="col-md-12">
                                    Nome:
                                    <input type="text" required class="form-control" name="nome" placeholder="Informe seu nome" value="<%=up.getNome()%>">
                                </label>
                                <label for="" class="col-md-12">
                                    Email:
                                    <input type="email" required class="form-control" name="email" placeholder="Insira seu email" value="<%=up.getEmail()%>">
                                </label>
                                <label for="" class="col-md-12">
                                    Senha:
                                    <input type="text" required class="form-control" name="senha" placeholder="Insira sua senha" value="<%=up.getSenha()%>">
                                </label>
