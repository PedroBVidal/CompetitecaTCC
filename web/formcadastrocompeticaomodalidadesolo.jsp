                                ...
                                <div class="card-body">
                                    ...
                                    <form action="scripts/cadastrarCompeticaoModalidadeSolo.jsp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputState">Modalidade solo:</label>
                                            <select id="modalidadeColetiva" class="form-control" name="modalidadeSolo">
                                                <%
                                                    ModalidadeSoloControle modalidadeSoloControle = new ModalidadeSoloControle();

                                                    for (ModalidadeSolo modalidadeSolo : modalidadeSoloControle.buscarTodosModalidadeSolo()) {

                                                %>
                                                <option value="<%=modalidadeSolo.getIdModalidadeSolo()%>"><%=modalidadeSolo.getNome()%></option>
                                                <%}%>
                                            </select>
                                        </div>
