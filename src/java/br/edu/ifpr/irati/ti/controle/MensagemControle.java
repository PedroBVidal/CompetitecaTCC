...
public class MensagemControle {
    ...
    public void enviarMensagem(Object remetente, Object destinatario,String categoria,String assunto, String mensagem){
        ...
        try{
            ...
            MensagemRecebida msgg = new MensagemRecebida(0,categoria,assunto ,mensagem, upar, upar2, 1, 1);
            ...
            MensagemRecebida msgg = new MensagemRecebida(0,categoria,assunto ,mensagem, upar, upar2, 1, 2);
            upar.addMensagem(msgg);
            upar2.addMensagem(msgg);
            msg.salvar(msgg);
            up.alterar(upar);
