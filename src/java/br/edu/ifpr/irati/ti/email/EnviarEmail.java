 ...
 */
package br.edu.ifpr.irati.ti.email;
...
public class EnviarEmail {
    ...
    public EnviarEmail(String emailDestinatario, String assunto, String msg) {
    ...
    public boolean enviarGmail() {
        ...
        Session s = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        ...
                        return new PasswordAuthentication("competiteca@gmail.com", "CompetitecaTCC#2019");//email e senha usuário 
                    }
                });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("competiteca@gmail.com"));
